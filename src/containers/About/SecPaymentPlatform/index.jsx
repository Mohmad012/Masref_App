          ...
          <div className="row align-items-center">
            <div className="col-12 col-lg-6 offset-lg-0 col-md-12 no-padding-left">
              <div className="ab-wrapper">
                ...
                <img className="wow abso-img2 fadeInUp floating animated" data-wow-delay="0.2s" src={img2} alt="" />
                <img className="abso-img3" src={img3} alt="" />
              </div> 
            </div>
            <div className="col-12 col-lg-6 offset-lg-0">
              <div className="who-we-contant mt-s">
                <div className="mb-15 text-left fadeInUp" data-wow-delay="0.2s">
                  <span className="gradient-text blue">Reliable Online Payment Platform</span>
                </div>
                <h4 className="fadeInUp" data-wow-delay="0.3s">Transfer and Deposite your money anytime, anywhere in the world</h4>
                <p className="fadeInUp" data-wow-delay="0.4s">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Suscipit eum illum tempora? Ducimus eum culpa voluptates dolorem dolorum et sit nisi, mollitia animi porro fuga sequi, molestias repellat excepturi nobis eum culpa voluptates dolorem dolorum et.</p>
