import {ServiceSingleInfo , ServicesBlockInfo} from '../../data/data-containers/data-Services.js'
    ...
    <>
      ...
      <section className=" section-padding-100-70">
        <div className="container">
          ...
          <div className="row">
            {ServiceSingleInfo && ServiceSingleInfo.map((item , key) => (
                <SecContent key={key} img={item.img} title={item.title} />
            ))}
          </div>
        </div>
      </section>
